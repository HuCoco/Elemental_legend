...
bool Water_1::Cast(cocos2d::Layer *_tag, const cocos2d::Vec2 _pos, int& _num)
{
    ...
    ResourceSystem::getInstance()->UpdateResourceBar(PLAYER,HEALTH, ADD, AttrSystem::getInstance()->GetRealAttr(ATTR_TYPE::ATTR_REHP));
