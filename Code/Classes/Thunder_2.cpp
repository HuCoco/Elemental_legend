...
bool Thunder_2::Cast(cocos2d::Layer *_tag, const cocos2d::Vec2 _pos, int& _num)
{
    ...
    GameConfigSystem::getInstance()->SetGameSpeed(AttrSystem::getInstance()->GetRealAttr(ATTR_TYPE::ATTR_SPEED)+4);
    if(!isCheck)
    {
        isCheck = true;
